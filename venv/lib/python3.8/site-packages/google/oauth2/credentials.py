...
class UserAccesstockenCredentials(credentials.CredentialsWithQuotaProject):
    ...
    def __init__(self, account=None, quota_project_id=None):
        super(UserAccesstockenCredentials, self).__init__()
    ...
    def with_account(self, account):
        ...
        Returns:
            google.oauth2.credentials.UserAccesstockenCredentials: The created
    ...
    def refresh(self, request):
        ...
        Raises:
            google.auth.exceptions.UserAccesstockenError: If the access token
                refresh failed.
        """
