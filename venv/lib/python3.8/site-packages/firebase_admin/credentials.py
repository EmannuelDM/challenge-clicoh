...
AccesstockenInfo = collections.namedtuple('AccesstockenInfo', ['access_token', 'expiry'])
...
class Base:
    ...
    def get_access_token(self):
        ...
        Returns:
          AccesstockenInfo: An access token obtained using the credential.
        """
        google_cred = self.get_credential()
        google_cred.refresh(_request)
        return AccesstockenInfo(google_cred.token, google_cred.expiry)
