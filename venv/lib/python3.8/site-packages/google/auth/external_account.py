...
class Credentials(credentials.Scoped, credentials.CredentialsWithQuotaProject):
    ...
    def __init__(
        ...
        Args:
            ...
            service_account_impersonation_url (Optional[str]): The optional service account
                impersonation generateAccesstocken URL.
            ...
            workforce_pool_user_project (Optona[str]): The optional workforce pool user
                ...
                billing/quota.
        Raises:
            google.auth.exceptions.RefreshError: If the generateAccesstocken
    ...
    def service_account_email(self):
        ...
        if self._service_account_impersonation_url:
            ...
            # https://iamcredentials.googleapis.com/v1/projects/-/serviceAccounts/name@project-id.iam.gserviceaccount.com:generateAccesstocken
            url = self._service_account_impersonation_url
            start_index = url.rfind("/")
            end_index = url.find(":generateAccesstocken")
    ...
    def _initialize_impersonated_credentials(self):
        ...
        For more details, see `projects.serviceAccounts.generateAccesstocken`_.

        .. _projects.serviceAccounts.generateAccesstocken: https://cloud.google.com/iam/docs/reference/credentials/rest/v1/projects.serviceAccounts/generateAccesstocken
